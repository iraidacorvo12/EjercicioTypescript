...
modificarPersonaPorDNI("71293f1212H", new direccion_1.Direccion("Calle Ramiro", 212, 6, "J", 334, "Valencia", "Comunitat Valencia"), new mail_1.Mail("personal", "aasdfas@gmail.com"), new telefono_1.Telefono("movil", 72342342));
